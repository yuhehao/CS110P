...
def main(assembly_files, num_cycles):
    ...
    for assembly_file in assembly_files:
        ...
        # Creates ref file
        if num_cycles == -1:
            os.system("java -jar venus-jvm-latest.jar -ur -t -tf trace_format -ti -tw -ts -r 32 " + assembly_file + " > " + ref_output)
        else:
            os.system("java -jar venus-jvm-latest.jar -ur -t -tf trace_format -ti -tw -ts -r 32 -tn " + str(num_cycles + 1) + " " + assembly_file + " > " + ref_output)
